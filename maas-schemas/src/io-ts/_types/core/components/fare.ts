...
export type Fare = t.Branded<
  {
    amount?: number | Null;
    currency?: Units_c404_.Currency | Common_ffba_.MetaCurrency | TokenId;
    tokenId?: TokenId;
    hidden?: boolean;
  ...
  t.IntersectionC<
    [
      t.PartialC<{
        ...
        currency: t.UnionC<
          [typeof Units_c404_.Currency, typeof Common_ffba_.MetaCurrency, typeof TokenId]
        >;
...
export const Fare: FareC = t.brand(
  t.intersection([
    t.partial({
      ...
      currency: t.union([Units_c404_.Currency, Common_ffba_.MetaCurrency, TokenId]),
      tokenId: TokenId,
      hidden: t.boolean,
