...
undefined
OpenTripPlanner itinerary V2, augmented with leg bookings per leg
...
import * as Booking_4353_ from './booking';
...
import * as LegV2_0fbd_ from './legV2';
import * as ProductOptionV2_8170_ from './product-optionV2';
...
export const schemaId = 'https://schemas.maas.global/core/itineraryV2.json';
...
export type ItineraryV2Brand = {
  readonly ItineraryV2: unique symbol;
};
...
export const examplesItineraryV2: NonEmptyArray<ItineraryV2> = [
  ...
  },
  {
    ...
    productOptions: [
      {
        type: 'BOOKING_ESTIMATABLE',
        customerId: 'dec87560-ac5c-11eb-a6fc-cb59ad789c50',
