...
// CountryCode
// The purpose of this remains a mystery
export type CountryCode = t.Branded<Address_2d0a_.Country, CountryCodeBrand>;
export type CountryCodeC = t.BrandC<typeof Address_2d0a_.Country, CountryCodeBrand>;
export const CountryCode: CountryCodeC = t.brand(
  Address_2d0a_.Country,
  (x): x is t.Branded<Address_2d0a_.Country, CountryCodeBrand> => true,
  'CountryCode',
);
