...
export type ApiUrl = t.Branded<string & Units_c404_.Url, ApiUrlBrand>;
export type ApiUrlC = t.BrandC<
  t.IntersectionC<[t.StringC, typeof Units_c404_.Url]>,
  ApiUrlBrand
>;
export const ApiUrl: ApiUrlC = t.brand(
  t.intersection([t.string, Units_c404_.Url]),
  (x): x is t.Branded<string & Units_c404_.Url, ApiUrlBrand> =>
