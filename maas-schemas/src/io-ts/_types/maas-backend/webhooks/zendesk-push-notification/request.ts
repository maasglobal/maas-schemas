...
export const schemaId =
  'https://schemas.maas.global/maas-backend/webhooks/zendesk-push-notification/request.json';
...
export type Request = t.Branded<
  {
    devices?: Array<
      {
        identifier?: Common_ffba_.DeviceToken;
        type?: 'ios' | 'android';
      } & {
        identifier: Defined;
        type: Defined;
      ...
      t.PartialC<{
        devices: t.ArrayC<
          t.IntersectionC<
            [
              t.PartialC<{
                identifier: typeof Common_ffba_.DeviceToken;
