...
export const schemaId =
  'https://schemas.maas.global/maas-backend/customers/payment-sources/paymentSource.json';
...
export type PaymentSource = t.Branded<
  {
    ...
    cardNumbers?: string;
    issuer?: string;
    billingCountry?: Station_dfde_.Country;
  ...
  t.IntersectionC<
    [
      t.PartialC<{
        ...
        issuer: t.StringC;
        billingCountry: typeof Station_dfde_.Country;
