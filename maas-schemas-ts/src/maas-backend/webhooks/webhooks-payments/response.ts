...
export const AvainpayResponse = t.brand(t.intersection([
  t.partial({
    action_str: t.string,
    data_type: t.string,
  ...
  ), AvainpayResponseBrand> => true, 'AvainpayResponse')
...
export const Response = t.brand(AvainpayResponse, (x): x is t.Branded<AvainpayResponse, ResponseBrand> => true, 'Response')
