...
export const schemaId = 'http://maasglobal.com/maas-backend/webhooks/webhooks-payments/gateway/avainpay.json';
...
export const Avainpay = t.brand(t.unknown, (x): x is t.Branded<unknown, AvainpayBrand> => true, 'Avainpay')
