...
export const LineItem = t.brand(t.intersection([
  t.partial({
    id: Subscription_.SubscriptionItemId,
    type: t.string,
...
export const Discount = t.brand(t.intersection([
  t.partial({
    description: t.string,
    discount: Cost_.Cost
  }),
...
export const Pricing = t.brand(t.intersection([
  t.partial({
