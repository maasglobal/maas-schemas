...
export const schemaId = 'http://maasglobal.com/maas-backend/itineraries/itinerary-create/response.json';
...
export const PaymentParameter = t.brand(t.partial({
  avainpay: PaymentParameters_.AvainpayPaymentParameters,
  stripe: PaymentParameters_.StripePaymentParameters
}), (x): x is t.Branded<{
  avainpay?: PaymentParameters_.AvainpayPaymentParameters,
  stripe?: PaymentParameters_.StripePaymentParameters
}, PaymentParameterBrand> => true, 'PaymentParameter')
...
export const PaymentParameters = t.brand(t.union([
  PaymentParameter,
  t.array(PaymentParameter)
]), (x): x is t.Branded<
  (
  | PaymentParameter
  | Array<PaymentParameter>
  ), PaymentParametersBrand> => true, 'PaymentParameters')
