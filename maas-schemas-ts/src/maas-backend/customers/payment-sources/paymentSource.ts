...
export const PaymentSourceId = t.brand(t.string, (x): x is t.Branded<string, PaymentSourceIdBrand> => ( typeof x !== 'string' || x.length >= 2 ), 'PaymentSourceId')
...
export const GatewayName = t.brand(t.string, (x): x is t.Branded<string, GatewayNameBrand> => ( typeof x !== 'string' || x.length >= 3 ) && ( typeof x !== 'string' || x.length <= 255 ), 'GatewayName')
...
export const Type = t.brand(t.string, (x): x is t.Branded<string, TypeBrand> => ( typeof x !== 'string' || x.length >= 3 ) && ( typeof x !== 'string' || x.length <= 100 ), 'Type')
...
export const Alias = t.brand(t.string, (x): x is t.Branded<string, AliasBrand> => ( typeof x !== 'string' || x.length >= 3 ) && ( typeof x !== 'string' || x.length <= 100 ), 'Alias')
...
export const Status = t.brand(t.string, (x): x is t.Branded<string, StatusBrand> => ( typeof x !== 'string' || x.length >= 2 ) && ( typeof x !== 'string' || x.length <= 255 ), 'Status')
...
export const SetupIntentId = t.brand(t.string, (x): x is t.Branded<string, SetupIntentIdBrand> => ( typeof x !== 'string' || x.length >= 2 ) && ( typeof x !== 'string' || x.length <= 255 ), 'SetupIntentId')
...
export const PaymentSource = t.brand(t.unknown, (x): x is t.Branded<unknown, PaymentSourceBrand> => true, 'PaymentSource')
