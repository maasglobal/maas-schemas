...
export const schemaId = 'http://maasglobal.com/maas-backend/customers/verification/verification-object.json';
...
export const Verification = t.brand(t.intersection([
  t.partial({
    id: t.string,
    identityId: Units_.IdentityId,
    ...
    status: t.string,
    type: t.string,
    stateLog: t.array(t.intersection([
      t.partial({
        status: t.string,
        timestamp: Units_.Time
      }),
  ...
  ), VerificationBrand> => true, 'Verification')
...
export const VerificationObject = t.brand(t.unknown, (x): x is t.Branded<unknown, VerificationObjectBrand> => true, 'VerificationObject')
