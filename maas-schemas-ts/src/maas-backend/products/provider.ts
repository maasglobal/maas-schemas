...
export const Provider = t.brand(t.intersection([
  t.partial({
    name: t.string,
    agencyId: Common_.AgencyId,
    groupId: t.string,
    ...
    requiredPersonalDocuments: t.array(PersonalDocumentRequiredItem_.PersonalDocumentRequiredItem),
    optionalParameters: t.array(t.intersection([
      t.partial({
        id: t.string,
        name: t.string,
        type: t.union([
