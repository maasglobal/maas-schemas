...
export const schemaId = 'http://maasglobal.com/maas-backend/invoices/invoiceLineItem.json';

// InvoiceLineItem
// The default export. More information at the top.
export type InvoiceLineItem = t.Branded<unknown, InvoiceLineItemBrand>
export const InvoiceLineItem = t.brand(t.unknown, (x): x is t.Branded<unknown, InvoiceLineItemBrand> => true, 'InvoiceLineItem')
