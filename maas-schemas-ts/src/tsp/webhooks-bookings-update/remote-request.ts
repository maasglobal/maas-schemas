...
export const schemaId = 'http://maasglobal.com/tsp/webhooks-bookings-update/remote-request.json';
...
export const RemoteRequest = t.brand(t.intersection([
  t.partial({
    tspId: Booking_.TspId,
    cost: Booking_.Cost,
    state: t.union([
  ...
  ), RemoteRequestBrand> => true, 'RemoteRequest')
