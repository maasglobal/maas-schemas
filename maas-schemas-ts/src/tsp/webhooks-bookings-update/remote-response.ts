...
export const BookingDelta = t.brand(t.intersection([
  t.partial({
    id: Units_.Uuid,
    tspId: Booking_.TspId,
    cost: Booking_.Cost,
  ...
  ), BookingDeltaBrand> => true, 'BookingDelta')
...
export const RemoteResponse = t.brand(t.partial({
  booking: BookingDelta,
  debug: t.type({
...
}, RemoteResponseBrand> => true, 'RemoteResponse')
