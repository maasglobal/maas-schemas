...
export const SubscriptionInstance = t.brand(t.intersection([
  t.partial({
    id: t.number,
    name: t.string,
    plan: t.intersection([
  ...
  ), SubscriptionInstanceBrand> => true, 'SubscriptionInstance')
...
export const Profile = t.brand(t.intersection([
  t.partial({
    id: t.number,
    identityId: Units_.IdentityId,
    phone: Common_.Phone,
