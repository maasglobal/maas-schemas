...
export const Mode = t.brand(t.union([
  TravelMode_.PersonalMode,
  TravelMode_.PublicTransitMode,
  TravelMode_.PrivateTransitMode
]), (x): x is t.Branded<
...
export const Stops = t.brand(t.array(Stop_.Stop), (x): x is t.Branded<Array<Stop_.Stop>, StopsBrand> => true, 'Stops')
...
export const Route = t.brand(t.string, (x): x is t.Branded<string, RouteBrand> => ( typeof x !== 'string' || x.length >= 1 ) && ( typeof x !== 'string' || x.length <= 255 ), 'Route')
...
export const RouteShortName = t.brand(t.string, (x): x is t.Branded<string, RouteShortNameBrand> => ( typeof x !== 'string' || x.length >= 1 ) && ( typeof x !== 'string' || x.length <= 64 ), 'RouteShortName')
...
export const RouteLongName = t.brand(t.string, (x): x is t.Branded<string, RouteLongNameBrand> => ( typeof x !== 'string' || x.length >= 1 ) && ( typeof x !== 'string' || x.length <= 255 ), 'RouteLongName')
...
export const LegGeometry = t.brand(t.partial({
  points: UnitsGeo_.Polyline
}), (x): x is t.Branded<{
  points?: UnitsGeo_.Polyline
}, LegGeometryBrand> => true, 'LegGeometry')
...
export const ProductOption = t.brand(t.number, (x): x is t.Branded<number, ProductOptionBrand> => ( Number.isInteger(x) ), 'ProductOption')
...
export const LegExtensions = t.brand(t.partial({
  id: Units_.Uuid,
  signature: Common_.Signature
}), (x): x is t.Branded<{
  id?: Units_.Uuid,
  signature?: Common_.Signature
}, LegExtensionsBrand> => true, 'LegExtensions')
...
export const LegCore = t.brand(t.intersection([
  t.partial({
    state: State,
    from: From,
    to: To,
...
export const WaitingLeg = t.brand(t.intersection([
  t.partial({
    startTime: Units_.Time,
    endTime: Units_.Time,
    mode: TravelMode_.WaitingMode
  ...
  ), WaitingLegBrand> => true, 'WaitingLeg')
...
export const TransferLeg = t.brand(t.intersection([
  t.partial({
    startTime: Units_.Time,
    endTime: Units_.Time,
    mode: TravelMode_.TransferMode
  ...
  ), TransferLegBrand> => true, 'TransferLeg')
...
export const Leg = t.brand(t.intersection([
  t.type({
