...
export const StripePaymentParameters = t.brand(t.partial({
  bookingId: Units_.Uuid,
  clientSecret: t.string
}), (x): x is t.Branded<{
  bookingId?: Units_.Uuid,
  clientSecret?: string
}, StripePaymentParametersBrand> => true, 'StripePaymentParameters')
...
export const AvainpayPaymentParameters = t.brand(t.union([
  t.partial({
  ...
  ), AvainpayPaymentParametersBrand> => true, 'AvainpayPaymentParameters')
...
export const PaymentParameters = t.brand(t.unknown, (x): x is t.Branded<unknown, PaymentParametersBrand> => true, 'PaymentParameters')
