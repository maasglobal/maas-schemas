...
export const TokenId = t.brand(t.string, (x): x is t.Branded<string, TokenIdBrand> => ( typeof x !== 'string' || x.match(RegExp("^[a-z]+(-[a-z]+)*-[a-z0-9_]+$")) !== null ), 'TokenId')
...
export const Fare = t.brand(t.intersection([
  t.partial({
    amount: t.union([
      t.number,
      t.null
