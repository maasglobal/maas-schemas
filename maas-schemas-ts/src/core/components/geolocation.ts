...
export const Properties = t.brand(t.intersection([
  t.partial({
    name: t.string,
  ...
  ), PropertiesBrand> => true, 'Properties')
...
export const Feature = t.brand(t.intersection([
  t.partial({
...
export const FeatureCollection = t.brand(t.intersection([
  t.partial({
  ...
  ), FeatureCollectionBrand> => true, 'FeatureCollection')
...
export const Geolocation = t.brand(t.unknown, (x): x is t.Branded<unknown, GeolocationBrand> => true, 'Geolocation')
