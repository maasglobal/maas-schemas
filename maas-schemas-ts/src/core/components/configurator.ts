...
export const Choice = t.brand(t.intersection([
  t.partial({
    id: t.string,
    name: t.string,
...
export const Config = t.brand(t.intersection([
  t.partial({
    type: t.union([
      t.literal('oneOf'),
      t.literal('someOf'),
...
export const Text = t.brand(t.intersection([
  t.partial({
    type: t.literal('text'),
    name: t.string,
    description: t.string,
...
export const Configurator = t.brand(t.partial({
  seatDirection: Config,
  seatPosition: Config,
  seatType: Config,
  seatFeatures: Config,
  ...
  freeReturn?: Config,
  ticketCollectionPoint?: Text
}, ConfiguratorBrand> => true, 'Configurator')
