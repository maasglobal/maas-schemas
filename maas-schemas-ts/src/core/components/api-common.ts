...
export const AcceptHeader = t.brand(t.string, (x): x is t.Branded<string, AcceptHeaderBrand> => ( typeof x !== 'string' || x.match(RegExp("\\bapplication/json[;,]\\s*version=((0|[1-9]\\d*)\\.(0|[1-9]\\d*)\\.(0|[1-9]\\d*)(-[\\da-z\\-]+(?:\\.[\\da-z\\-]+)*)?(?:\\+[\\da-z\\-]+(?:\\.[\\da-z\\-]+)*)?)\\b")) !== null ), 'AcceptHeader')
...
export const UserAgentHeader = t.brand(t.string, (x): x is t.Branded<string, UserAgentHeaderBrand> => ( typeof x !== 'string' || x.length >= 1 ), 'UserAgentHeader')
...
export const Headers = t.brand(t.partial({
  Accept: AcceptHeader,
  'X-Whim-User-Agent': UserAgentHeader
}), (x): x is t.Branded<{
  Accept?: AcceptHeader,
  'X-Whim-User-Agent'?: UserAgentHeader
}, HeadersBrand> => true, 'Headers')
...
export const ApiCommon = t.brand(t.unknown, (x): x is t.Branded<unknown, ApiCommonBrand> => true, 'ApiCommon')
