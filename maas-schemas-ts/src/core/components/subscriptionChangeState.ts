...
export const schemaId = 'http://maasglobal.com/core/components/subscriptionChangeState.json';
...
export const SubscriptionChangeState = t.brand(t.intersection([
  t.partial({
    id: Units_.Uuid,
  ...
  ), SubscriptionChangeStateBrand> => true, 'SubscriptionChangeState')
