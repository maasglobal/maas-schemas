...
export const Id = t.brand(t.string, (x): x is t.Branded<string, IdBrand> => ( typeof x !== 'string' || x.length >= 1 ) && ( typeof x !== 'string' || x.length <= 64 ), 'Id')
...
export const Code = t.brand(t.string, (x): x is t.Branded<string, CodeBrand> => true, 'Code')
...
export const Name = t.brand(t.string, (x): x is t.Branded<string, NameBrand> => true, 'Name')
...
export const OpeningHours = t.brand(t.type({

}), (x): x is t.Branded<{

}, OpeningHoursBrand> => true, 'OpeningHours')
...
export const Facilities = t.brand(t.array(t.string), (x): x is t.Branded<Array<string>, FacilitiesBrand> => true, 'Facilities')
...
export const Services = t.brand(t.array(TravelMode_.TravelMode), (x): x is t.Branded<Array<TravelMode_.TravelMode>, ServicesBrand> => true, 'Services')
...
export type Timetables = t.Branded<Array<{
  id?: string,
...
export const Timetables = t.brand(t.array(t.partial({
  id: t.string,
  mode: TravelMode_.TravelMode,
  name: t.string,
  longName: t.string,
  ...
  realtime?: Units_.Time,
  isRealtime?: boolean
}>, TimetablesBrand> => true, 'Timetables')
...
export type Zone = t.Branded<
  (
  | number
  | string
  ), ZoneBrand>
export const Zone = t.brand(t.union([
  t.number,
  t.string
]), (x): x is t.Branded<
  (
...
// PlatformCode
// Platform number
export type PlatformCode = t.Branded<
  (
  | number
  | string
  ), PlatformCodeBrand>
export const PlatformCode = t.brand(t.union([
  t.number,
  t.string
]), (x): x is t.Branded<
  (
  | number
  | string
  ), PlatformCodeBrand> => true, 'PlatformCode')
...
export const Station = t.brand(t.type({

}), (x): x is t.Branded<{

}, StationBrand> => true, 'Station')
