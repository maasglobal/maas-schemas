...
export const ConfigChoiceSelection = t.brand(t.array(t.string), (x): x is t.Branded<Array<string>, ConfigChoiceSelectionBrand> => true, 'ConfigChoiceSelection')
...
export const TextInputSelection = t.brand(t.string, (x): x is t.Branded<string, TextInputSelectionBrand> => ( typeof x !== 'string' || x.length <= 8192 ), 'TextInputSelection')
...
export const CustomerSelection = t.brand(t.partial({
  seatDirection: ConfigChoiceSelection,
  seatPosition: ConfigChoiceSelection,
  seatType: ConfigChoiceSelection,
  seatFeatures: ConfigChoiceSelection,
  ...
  freeReturn?: ConfigChoiceSelection,
  ticketCollectionPoint?: TextInputSelection
}, CustomerSelectionBrand> => true, 'CustomerSelection')
