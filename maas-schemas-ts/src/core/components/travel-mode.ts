...
export type WaitingMode = t.Branded<
  (
  & string
  & 'WAIT'
  ), WaitingModeBrand>
export const WaitingMode = t.brand(t.intersection([
  t.string,
  t.literal('WAIT')
]), (x): x is t.Branded<
  (
  & string
  & 'WAIT'
  ), WaitingModeBrand> => true, 'WaitingMode')
...
export const TransferMode = t.brand(t.intersection([
  t.string,
  t.union([
    t.literal('LEG_SWITCH'),
    t.literal('TRANSFER')
  ])
]), (x): x is t.Branded<
  (
  ...
  ), TransferModeBrand> => true, 'TransferMode')
...
export const PersonalMode = t.brand(t.intersection([
  t.string,
  t.union([
    t.literal('BICYCLE'),
    t.literal('CAR'),
  ...
  ), PersonalModeBrand> => true, 'PersonalMode')
...
export const PublicTransitMode = t.brand(t.intersection([
  t.string,
  t.union([
    t.literal('AEROPLANE'),
    t.literal('BUS'),
  ...
  ), PublicTransitModeBrand> => true, 'PublicTransitMode')
...
export const PrivateTransitMode = t.brand(t.intersection([
  t.string,
  t.union([
    t.literal('BUSISH'),
    t.literal('CABLE_CAR'),
  ...
  ), PrivateTransitModeBrand> => true, 'PrivateTransitMode')
...
export const TravelMode = t.brand(t.union([
  WaitingMode,
  TransferMode,
  PersonalMode,
  PublicTransitMode,
  ...
  | PublicTransitMode
  | PrivateTransitMode
  ), TravelModeBrand> => true, 'TravelMode')
