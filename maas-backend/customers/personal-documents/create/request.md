...
```
http://maasglobal.com/maas-backend/customers/personal-documents/create/request.json
```
...
| ------------------- | ---------- | ------- | ------------ | ----------------- | --------------------- | ----------------------------------------------------------------------------- |
| Can be instantiated | No         | Develop | No           | Forbidden         | Forbidden             | [maas-backend/customers/personal-documents/create/request.json](request.json) |

## Schema Hierarchy

- request `http://maasglobal.com/maas-backend/customers/personal-documents/create/request.json`
...
| [payload](#payload)       | personal-document | **Required** | No       | request (this schema) |
