...
```
http://maasglobal.com/maas-backend/coupons/coupons-validate/request.json
```
...
| ------------------- | ---------- | ------- | ------------ | ----------------- | --------------------- | ------------------------------------------------------------------ |
| Can be instantiated | No         | Develop | No           | Forbidden         | Forbidden             | [maas-backend/coupons/coupons-validate/request.json](request.json) |

## Schema Hierarchy

- request `http://maasglobal.com/maas-backend/coupons/coupons-validate/request.json`
